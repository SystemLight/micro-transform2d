export class Transform2D {
    ...
    setTranslate(x: number, y: number, relative: boolean) {
    ...
    setScale(sca: number, relative: boolean) {
    ...
    setRotate(angle: number, relative: boolean) {
    ...
    setSkew(xAngle: number, yAngle: number = 0, relative: boolean) {
